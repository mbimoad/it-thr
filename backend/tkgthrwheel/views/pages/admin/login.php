...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/tapstore/login/login.css">
</head>
<body data-base_url="<?php echo base_url(); ?>">
    <div class="form">
        <a href="/tkgsdh/tkgplaystore" class="backbtn">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M22 20.418C19.5533 17.4313 17.3807 15.7367 15.482 15.334C13.5833 14.9313 11.7757 14.8705 10.059 15.1515V20.5L2 11.7725L10.059 3.5V8.5835C13.2333 8.6085 15.932 9.74733 18.155 12C20.3777 14.2527 21.6593 17.0587 22 20.418Z" fill="black" stroke="black" stroke-width="2" stroke-linejoin="round"/>
            </svg>
        </a>
        ...
        <div class="inputGroup inputGroup1">
            <label for="email1">TTID</label>
            <input type="text" id="email" class="email ttid" maxlength="256"/>
            <p class="helper helper1">Your TKG TTID</p>
        ...
        <div class="alert-wrong hide">
            <span>Please check your username/password</span>
        </div>
</div>

    <script src="<?php echo base_url(); ?>assets/tapstore/login/jquery-3.7.1.min.js"></script>
    <script src="<?= base_url() ?>assets/tapstore/login/login.js"></script>
    <script src="<?= base_url() ?>assets/tapstore/backend/js/tkgbackend.js"></script>
